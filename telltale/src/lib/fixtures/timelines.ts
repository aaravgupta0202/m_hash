  ...
  session: [
    {
      ...
      sensitivity: "low",
      note: "Corporate ASN 24560 · Bengaluru",
    },
    {
      t: 785,
      ts: "2026-09-14T13:05:40Z",
      action: "okta.token.refresh",
      sensitivity: "low",
    },
  ],
  trajectory: [
    {
      t: 570,
      ts: "2026-09-14T09:30:18Z",
      action: "jira.issue.comment",
      resource: "TICKET-4471",
      sensitivity: "low",
    },
    {
      t: 615,
      ...
      firstEver: true,
      note: "First access in 180d",
    },
    {
      t: 622,
      ts: "2026-09-14T10:22:05Z",
      action: "github.branch.create",
      resource: "fix/ledger-rounding",
      sensitivity: "medium",
    },
    {
      t: 664,
      ...
      resource: "payments-core#2244",
      sensitivity: "low",
    },
    {
      t: 820,
      ts: "2026-09-14T13:40:12Z",
      action: "github.pr.review",
      resource: "billing-web#1907",
      sensitivity: "low",
    },
    {
      t: 912,
      ts: "2026-09-14T15:12:33Z",
  ...
  context: [
    {
      ...
      label: "Scope-matched ticket · assigned by subject_5530",
      verdict: "authorised",
    },
  ],
  risk: [
...
const marcus: CompositeTimeline = {
  ...
  session: [
    {
      ...
      asnChange: true,
      firstEver: true,
      note: "ASN 51167 · commercial VPN · Zurich · first in 180d",
    },
    {
      t: 78,
      ts: "2026-09-14T01:18:20Z",
      action: "okta.mfa.challenge",
      sensitivity: "medium",
      note: "Push approved · device fingerprint unrecognised",
    },
    {
      t: 542,
      ts: "2026-09-14T09:02:51Z",
      action: "okta.session.start",
      sensitivity: "low",
      note: "Corporate ASN 24560 · Bengaluru",
    },
  ...
  trajectory: [
    ...
    },
    {
      ...
      resource: "s3://ext-7731-backup",
      sensitivity: "critical",
      firstEver: true,
      note: "Outside org account boundary",
    },
    {
      t: 554,
      ts: "2026-09-14T09:14:30Z",
      action: "github.pr.review",
      resource: "ledger-api#884",
      sensitivity: "low",
    },
    {
      t: 630,
      ts: "2026-09-14T10:30:02Z",
      action: "jira.issue.comment",
      resource: "SPRINT-2291",
      sensitivity: "low",
    },
    {
      t: 705,
      ts: "2026-09-14T11:45:19Z",
      action: "github.repo.clone",
      resource: "ledger-api",
      sensitivity: "medium",
    },
    {
      t: 860,
      ts: "2026-09-14T14:20:44Z",
      action: "github.pr.open",
      resource: "ledger-api#889",
      sensitivity: "low",
    },
    {
      t: 965,
      ts: "2026-09-14T16:05:08Z",
      action: "slack.channel.join",
      resource: "#platform-oncall",
      sensitivity: "low",
    },
  ],
  context: [
    {
      from: 540,
      to: 1050,
      recordId: "SPRINT-2291",
      label: "Sprint assignment · ledger-api · assigned by subject_6302",
      verdict: "authorised",
    },
  ],
  risk: [
...
const dana: CompositeTimeline = {
  ...
  session: [
    {
      t: 538,
      ts: "2026-09-14T08:58:44Z",
      action: "okta.session.start",
      sensitivity: "low",
      note: "Corporate ASN 24560 · Pune",
    },
    {
      t: 840,
      ts: "2026-09-14T14:00:11Z",
      action: "okta.token.refresh",
      sensitivity: "low",
    },
  ],
  trajectory: [
    ...
    {
      t: 675,
      ts: "2026-09-14T11:15:03Z",
      action: "github.pr.review",
      resource: "ledger-api#886",
      sensitivity: "low",
    },
    {
      t: 845,
      ts: "2026-09-14T14:05:38Z",
      action: "jira.ticket.create",
      resource: "TICKET-9920",
      sensitivity: "medium",
      note: "Created by the subject",
    },
    {
      t: 847,
      ts: "2026-09-14T14:07:02Z",
      action: "jira.ticket.assign",
      resource: "TICKET-9920",
      sensitivity: "high",
      note: "Assignee = creator",
    },
    {
      t: 887,
      ...
      sensitivity: "critical",
      firstEver: true,
      note: "First ever · 40m after the record",
    },
    {
      t: 902,
      ts: "2026-09-14T15:02:44Z",
      action: "github.archive.create",
      resource: "export.tar.gz",
      sensitivity: "critical",
      note: "38 files",
    },
    {
      ...
      action: "dropbox.file.upload",
      resource: "personal-account",
      sensitivity: "critical",
      firstEver: true,
      note: "Personal cloud account",
    },
  ],
  context: [
    {
      ...
      label: "Self-created, self-assigned · provenance failed",
      verdict: "suspicious",
    },
  ],
  risk: [
...
export const ALL_TIMELINES: CompositeTimeline[] = [
  ...TIMELINES,
  ...QUEUE_TIMELINES,
];
